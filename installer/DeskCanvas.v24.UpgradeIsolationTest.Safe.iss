; Isolation-only upgrade test. Every registry key is below HKCU\Software\DeskCanvas\InstallerIsolation.
...
[Setup]
AppId={{5B5F16B4-55FB-4F31-9B11-11C0DF82CA5A}
AppName={#AppName}
...
OutputBaseFilename=DeskCanvas-UpgradeIsolationSafe-{#AppVersion}
