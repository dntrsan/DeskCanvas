...
[InstallDelete]
; Remove only prior program payload inside {app}; user data is outside this directory.
; Do not delete Inno's unins*.exe/dat files while its upgrade transaction is active.
