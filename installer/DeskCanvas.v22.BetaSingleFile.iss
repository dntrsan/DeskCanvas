...
#define PayloadPath "..\artifacts\beta\DeskCanvas-1.2.0-beta.1-win-x64\DeskCanvas.exe"
...
[InstallDelete]
; This only removes the known in-place app payload. User data and Inno's own
; uninstaller files are deliberately outside these patterns.
