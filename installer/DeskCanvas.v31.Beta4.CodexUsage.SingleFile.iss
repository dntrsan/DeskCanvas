...
#endif
#ifndef AppVersion
  #define AppVersion "1.2.0-beta.4"
#endif
#ifndef AppFileVersion
  #define AppFileVersion "1.2.0.4"
#endif
#ifndef AppExeName
  #define AppExeName "DeskCanvas.exe"
#endif
#ifndef PayloadPath
  #define PayloadPath "..\artifacts\beta\DeskCanvas-1.2.0-beta.4-win-x64\DeskCanvas.exe"
#endif
...
var HadStartupRegistration: Boolean;
...
begin
  if CurStep = ssInstall then begin HadStartupRegistration := HasDeskCanvasRunValue(StartupKey) or HasDeskCanvasRunValue(StartupRunOnceKey) or HasPathMatch('{userstartup}\DeskCanvas*.lnk'); RemoveLegacyStartup; end;
  if CurStep = ssPostInstall then begin RemoveLegacyStartup; if HadStartupRegistration or WizardIsTaskSelected('startup') then RegWriteStringValue(HKCU, StartupKey, StartupValue, '"' + ExpandConstant('{app}\{#AppExeName}') + '"'); end;
end;
