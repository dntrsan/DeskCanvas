...
internal static class V20WaveProgressMathTests
{
    [ModuleInitializer]
    internal static void Run()
    {
        ...
        var phase = WaveProgressMath.AdvancePhase(.97, WaveProgressMath.RunningSpeed, .3);
        if (phase <= .99 || phase >= 1 || WaveProgressMath.ClampRatio(double.NaN) != 0)
