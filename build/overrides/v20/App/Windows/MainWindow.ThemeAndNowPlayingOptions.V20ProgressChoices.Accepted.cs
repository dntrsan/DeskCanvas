...
public partial class MainWindow
{
    ...
    private static void OnAnyMainWindowLoaded(object sender, RoutedEventArgs e) { if (sender is MainWindow window) window.EnsureThemeEditor(); }
    ...
    private void NowPlayingOptionChanged(object sender, RoutedEventArgs e)
    {
        ...
        item.NowPlaying.ShowSpectrum = spectrumVisibleCheck.IsChecked == true; item.NowPlaying.ProgressStyle = progressStyleCombo.SelectedItem is ProgressChoice style ? style.Value : NowPlayingProgressStyle.Simple;
