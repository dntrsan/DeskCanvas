...
// Do not reorder: Dots/Hearts remain persisted numeric compatibility values from v1.9.
...
{
    private NowPlayingProgressStyle progressStyle = NowPlayingProgressStyle.Simple;
    ...
    public NowPlayingProgressStyle ProgressStyle { get => progressStyle; set => progressStyle = NormalizeProgressStyle(value); }

    public static NowPlayingProgressStyle NormalizeProgressStyle(NowPlayingProgressStyle value) => value switch
    {
        NowPlayingProgressStyle.Simple => NowPlayingProgressStyle.Simple,
        NowPlayingProgressStyle.Wave => NowPlayingProgressStyle.Wave,
        // v1.9 custom styles are deliberately retired; preserve a pleasant custom timeline.
        NowPlayingProgressStyle.Dots or NowPlayingProgressStyle.Hearts => NowPlayingProgressStyle.Wave,
        _ => NowPlayingProgressStyle.Simple
    };
