...
internal sealed class BuiltInContentPicker : Window
{
    ...
    private void ApplyOptions()
    {
        ...
        previewItem.NowPlaying.ProgressStyle = progressStyle.SelectedItem is ProgressChoice progress ? progress.Value : NowPlayingProgressStyle.Simple;
    ...
    private static readonly ProgressChoice[] ProgressChoices = [new(NowPlayingProgressStyle.Simple, "シンプル"), new(NowPlayingProgressStyle.Wave, "ウェーブ"), new(NowPlayingProgressStyle.Dots, "ドット"), new(NowPlayingProgressStyle.Hearts, "ハート")];
    private static ProgressChoice Choice(NowPlayingProgressStyle value) => ProgressChoices.First(choice => choice.Value == value);
