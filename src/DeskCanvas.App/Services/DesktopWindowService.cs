...
internal sealed class DesktopWindowService
{
        ...
        double height)
    {
        ...
        var insertAfter = aboveDesktop == IntPtr.Zero ? IntPtr.Zero : aboveDesktop;
        if (!SetWindowPos(
                window,
                insertAfter,
    ...
    internal void MoveAbove(IntPtr window, IntPtr lowerWindow)
    {
        _ = SetWindowPos(
            window,
            lowerWindow,
            ...
            0,
            0,
            SwpNoActivate | 0x0001 | 0x0002);
    }

    internal (double X, double Y) GetCursorPosition()
    {
