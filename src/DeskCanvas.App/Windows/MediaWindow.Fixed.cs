...
public partial class MediaWindow : Window, IDisposable
{
    ...
    private System.Windows.Point startScreen;
    ...
    private void OnClosing(object? sender, CancelEventArgs e) => animationTimer?.Stop();
    ...
    private void ApplyItem()
    {
        ...
        MediaImage.RenderTransformOrigin = new System.Windows.Point(0.5, 0.5);
    ...
    private void Visual_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e) =>
        ApplyChromeVisibility(forceVisible: true);

    private void Visual_MouseLeave(object sender, System.Windows.Input.MouseEventArgs e)
    {
    ...
    {
        var visible = editEnabled &&
                      (forceVisible || RotatedVisual.IsMouseOver || dragOperation != DragOperation.None);
    ...
    private void ResizeFromDelta(double dx, double dy)
    {
        ...
        var scale = Math.Max(
            48 / Math.Min(startWidth, startHeight),
    ...
    private double PointerAngle(System.Windows.Point screenPoint) =>
